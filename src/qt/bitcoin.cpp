...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Czecoin");
    QApplication::setOrganizationDomain("Czecoin.com");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Czecoin-Qt-testnet");
    else
        QApplication::setApplicationName("Czecoin-Qt");
