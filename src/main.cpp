...
#if defined(NDEBUG)
# error "Czecoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x00000d5ec21c037b100e9ff17d366398f7f9e0d76b835473cdd97edb941d885d");
uint256 hashGenesisBlockTestNet("0x0");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Czecoin: starting difficulty is 1 / 2^12
...
unsigned int nStakeMinAge = 24 * 60 * 60; // 1day
...
{
    // Czecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if (nHeight == 0) {
        ...
        // Premine: First 10 block are 545,000,000 CZECO (5% of the total coin)
...
const int64 nTargetSpacing = 240; // Czecoin: 4 minute block
static const int64 nTargetTimespan = 60 * 60; // Czecoin: Not used
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    static const int64 BlocksTargetSpacing = 1 * 240; // 4 Minute
...
{
    // Czecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0xb51773dc6024b0b9e0619c83bbabd3f28805759a4c61d6e8fd1a4dc629e4f9353"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Czecoin: increase each by adding 2 to bitcoin's value.
