Czecoin-Qt: Qt4 GUI for Czecoin
===============================
...
Alternatively, install `Qt Creator`_ and open the `Czecoin-qt.pro` file.
...
- If using HomeBrew,  edit `Czecoin-qt.pro` to account for library location differences. There's a diff in `contrib/homebrew/bitcoin-qt-pro.patch` that shows what you need to change, or you can just patch by doing

        patch -p1 < contrib/homebrew/bitcoin.qt.pro.patch

- Open the Czecoin-qt.pro file in Qt Creator and build as normal (cmd-B)
...
The static binary version of Czecoin is linked against libdb4.8 (see also `this Debian issue`_).
